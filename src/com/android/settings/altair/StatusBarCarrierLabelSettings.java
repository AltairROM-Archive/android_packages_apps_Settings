...
import com.android.settings.utils.AicpUtils;
...
public class StatusBarCarrierLabelSettings extends SettingsPreferenceFragment
    ...
    private static final String TAG = "StatusBarCarrierLabel";
    private static final int RESID = R.xml.status_bar_carrier_label_settings;
    ...
    public void onCreate(Bundle icicle) {
        ...
        if (!AicpUtils.isVoiceCapable(getContext())) {
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        ...
        if (preference == mCarrierColorPicker) {
            ...
            Settings.System.putIntForUser(resolver,
                    ...
                    showCarrierLabel, UserHandle.USER_CURRENT);
            ...
            Settings.System.putIntForUser(resolver,
                    ...
                    statusBarCarrierSpot, UserHandle.USER_CURRENT);
