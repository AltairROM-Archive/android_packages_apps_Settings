...
public class SettingsDialogPreference<T extends DialogInterface> extends DialogPreference {

    private CustomPreferenceDialogFragment mFragment;

    public SettingsDialogPreference(Context context, AttributeSet attrs, int defStyleAttr,
            int defStyleRes) {
    ...
    public static class CustomPreferenceDialogFragment extends PreferenceDialogFragment {
        ...
        private SettingsDialogPreference getCustomizablePreference() {
            return (SettingsDialogPreference) getPreference();
        }
