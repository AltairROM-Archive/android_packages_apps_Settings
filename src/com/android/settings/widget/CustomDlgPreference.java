...
public class CustomDlgPreference<T extends DialogInterface> extends DialogPreference {

    private CustomPreferenceDialogFragment mFragment;

    public CustomDlgPreference(Context context, AttributeSet attrs, int defStyleAttr,
            int defStyleRes) {
    ...
    public CustomDlgPreference(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public CustomDlgPreference(Context context) {
        super(context);
    }
    ...
    public static class CustomPreferenceDialogFragment extends PreferenceDialogFragment {
        ...
        private CustomDlgPreference getCustomizablePreference() {
            return (CustomDlgPreference) getPreference();
        }
