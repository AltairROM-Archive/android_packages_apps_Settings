...
import com.android.settings.utils.ShortcutPickHelper;

import java.io.File;
import java.io.IOException;
import java.util.ArrayList;

public class LockscreenStyleSettings extends PreferenceActivity implements
                ...
                if (items.length == 0) {
                    ...
                    builder.setNeutralButton(R.string.pref_lockscreen_ring_custom_apps_dialog_remove,
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            AlertDialog.Builder builder = new AlertDialog.Builder(LockscreenStyleSettings.this);
